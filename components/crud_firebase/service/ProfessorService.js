...
class ProfessorService {
    ...
    static criar = (firestoreDb, callback, professores)=>{
        addDoc(collection(firestoreDb,'professor'), professores)
        .then(
            (docRef)=>{
                callback(docRef.id);
            }
    ...
    static atualizar = (firestoreDb, callback, id, professores)=>{
        updateDoc( doc(firestoreDb,'professor',id), professores)
        .then(
            ()=>{
                callback();
            }
